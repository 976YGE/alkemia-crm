...
import { ArrowLeft, CreditCard as Edit2, FileText, ExternalLink, Ban } from 'lucide-react';
  ...
  return (
    <MainLayout>
      <div className="space-y-6 max-w-4xl mx-auto pb-20 md:pb-4">
          ...
          <Card>
            <CardContent className="py-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="font-semibold text-slate-900">{t('sales.noSaleLabel')}</p>
                  <p className="text-sm text-slate-500">{t('sales.noSaleDescription')}</p>
                </div>
              </div>
              {report.comment && (
                <div className="mt-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                  <p className="text-sm font-medium text-slate-700 mb-1">{t('sales.comment')}</p>
        ...
        {!report.is_no_sale && report.proof_file_path && (
          <Card>
            <CardHeader>
